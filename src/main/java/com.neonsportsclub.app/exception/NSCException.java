...
import com.neonsportsclub.app.config.PropertiesConfig;
 ...
 */
@Component
public class NSCException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public NSCException(PropertiesConfig propertiesConfig) {
        NSCException.propertiesConfig = propertiesConfig;
    }
