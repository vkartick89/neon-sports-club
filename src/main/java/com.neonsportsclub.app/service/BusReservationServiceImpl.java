...
import com.neonsportsclub.app.dto.mapper.TicketMapper;
import com.neonsportsclub.app.dto.mapper.TripMapper;
import com.neonsportsclub.app.dto.mapper.TripScheduleMapper;
...
import com.neonsportsclub.app.model.bus.*;
import com.neonsportsclub.app.model.user.User;
import com.neonsportsclub.app.repository.bus.*;
import com.neonsportsclub.app.repository.user.UserRepository;
import com.neonsportsclub.app.util.RandomStringUtil;
...
import static com.neonsportsclub.app.exception.EntityType.*;
import static com.neonsportsclub.app.exception.ExceptionType.*;
...
public class BusReservationServiceImpl implements BusReservationService {
    ...
    private RuntimeException exceptionWithId(EntityType entityType, ExceptionType exceptionType, Integer id, String... args) {
        return NSCException.throwExceptionWithId(entityType, exceptionType, id, args);
    }
}
